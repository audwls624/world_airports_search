...
try:
    with conn.cursor() as cursor:
        ...
        sql3 = '''CREATE TABLE cities (ID int NOT NULL auto_increment, korean_name varchar(200), english_name varchar(200), country_id int NOT NULL, PRIMARY KEY (ID), FOREIGN KEY (country_id) REFERENCES countries (ID))'''
